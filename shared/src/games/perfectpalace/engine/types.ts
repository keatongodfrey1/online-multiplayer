...
export interface GameState {
  ...
  // Serializable PRNG state (mulberry32). The SERVER owns all randomness; every
  // deck shuffle and die roll is drawn from this seed so games are deterministic
  // and survive save/resume. Advanced by advanceRng() in the reducer.
  rngState: number
