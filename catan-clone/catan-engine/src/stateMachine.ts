...
function publicVictoryPoints(state: GameState, player: PlayerId): number {
  let vp = 0;
...
export { mulberry32, shuffle, handCount, satisfiesDistanceRule, STANDARD_HEX_COORDS, updateLongestRoad };
