// Reducer tests — exercises every gameplay rule from DESIGN.md.
// Organized by section; each scenario is self-contained.
//
// Run with:  bun run test

import { describe, it, expect } from 'vitest'
import { initialState, reducer, isValidResourceCard } from './reducer'
import type { GameState, Player, ResourceCard } from './types'
import { RESOURCE_OPTIONS } from './types'
import { rankPlayers, totalPoints, staffWeight } from './scoring'
